...
export default function App() {
  ...
  return (
    <html lang='en' className={`${themePreferences}`}>
      ...
      <body className='bg-lightBg font-sans text-lightText dark:bg-darkBg dark:text-white'>
        <nav className='mb-12 flex h-[80px] items-center justify-between px-4 text-lightText shadow-nav dark:bg-darkElement dark:text-white md:px-[80px]'>
          <Link className='text-sm font-extrabold md:text-2xl' to='/'>
          ...
          <Form method='post' action='/change-theme'>
            ...
            <input
              type='hidden'
              name='theme'
              value={themePreferences !== 'dark' ? 'dark' : 'light'}
            />
            <input
              type='hidden'
              name='returnTo'
